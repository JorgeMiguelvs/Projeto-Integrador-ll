...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="preco" step=".01" min="1" max="99999"  onkeypress="return semLetra(event)" aria-describedby="emailHelp" placeholder="Digite o preço" required>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="desconto" step="0.01" min="1" onkeypress="return semLetra(event)" aria-describedby="emailHelp" placeholder="Digite o desconto" required>
  </div>
...
<button type="submit" class="btn btn-primary" role="button">Cadastrar</button> <a class="btn btn-primary" href="listarProduto.php" role="button">Consultar</a>
</form>
    </div>
   </div>
    </div>
